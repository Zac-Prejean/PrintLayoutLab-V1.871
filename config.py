...
sku_to_fontsize_placement = {**deskplates_sku_to_fontsize_placement, **glfbl_sku_to_fontsize_placement, **mug_sku_to_fontsize_placement, **nck_sku_to_fontsize_placement, **planks_sku_to_fontsize_placement, **tumbler_sku_to_fontsize_placement}    
...
def save_image_with_subfolders(clean_sku, sku, order_number, index, qty_index, item_options, folder_name, image):  
    ...
    if sub_folder_name:  
        ...
        print(f"{sku} saved as {image_name} in folder {sub_folder_name}")  
    else:  
    ...
    if clean_sku.startswith("JMUG11WB"):  
        ...
        print(f"Images saved in folder {sub_folder_name}: {images_saved_in_subfolder[sub_folder_name]}")  
