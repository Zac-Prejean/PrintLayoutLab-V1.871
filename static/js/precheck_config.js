...
const oneLineMUG = [
    ...
    //  customizable
    'UVPJMSAYOCMUVP', 'UVPPSWIPEUVP', 'UVPPSMUWRMUVP', 'UVPJMBTOIMUVP', 'UVPPSSPERMMUVP', 'SUBUYTHTSUB', 'UVPJMFMEMUVP',
    'UVPPSYBCMUVP', 'UVPPSBALLS2UVP', 'UVPCCFREKEX1UVP','UVPJMCCTNR1UVP', 'UVPJMCCAS1UVP', 'UVPJMCCDS1UVP', 'UVPPSBONDUVP',
    'UVPPSLILMSUVP', 'UVPPSLILMGUVP', 'UVPPSLILMPUVP', 'SUBJMSUWOMSUB', 'UVPPSPFCMUVP', 'UVPPSLAYBNSMUVP', 'UVPPSGDMNUVP',
    'UVPJMIFLYMUVP', 'UVPPSNORMUVP', 'UVPPSDLGFBMUVP', 'UVPPSBOBWUVP', 'UVPPSFARTUVP', 'UVPJMMCMWLYUVP',
...
const twoLineMUG = [
    ...
    //  customizable
    'UVPPSICG1UVP', 'UVPPSLNTBBUVP', 'UVPPSTYBMUVP', 'UVPJMCCAS2UVP', 'UVPJMCCTNR2UVP', 'UVPJMCCDS2UVP', 'UVPPSSBNALUVP', 'UVPPSCRAYMUVP', 'UVPPS2FAVCHUVP',
    'UVPPSSCMUVP',
];
...
export { prefixACSKTUM16ZPNK, prefixACSKTUM16ZBLK, prefixACSKTUM16ZICB, prefixACSKTUM16ZMNT, prefixACSKTUM18ZDBL, prefixACSKTUM18ZCLGD, 
    prefixACSKTUM18ZCLRGD, nameplates, prefixGLFBLWHTSO, oneLineTum, Lineglscan, oneLineGLFBL, twoLineBCT, combinedWOOD, nonLineWOOD, 
...
export const validSkus = [...validSkus_deskplates, ...validSkus_pinkTum, ...validSkus_blackTum, ...validSkus_iceTum, ...validSkus_mintTum, 
    ...
    ...validSkus_3plank, ...validSkus_nonmug, ...validSkus_1mug, ...validSkus_2mug, ...validSkus_3mug, ...validSkus_4mug, ...nameplates, 
    ...validSkus_GLFBL, ...validSkus_bracelet];
